...
__device__ inline void output_type_cl_init(output_type_cl* out, float* ptr); // Function prototype in mutate_conf.cpp
__device__ inline void output_type_cl_init_with_output(output_type_cl* out_new, const output_type_cl* out_old);// Function prototype in mutate_conf.cpp
...
__device__ inline float find_change_index_read(const change_cl* g, int index) {
...
__device__ inline void find_change_index_write(change_cl* g, int index, float data) {
